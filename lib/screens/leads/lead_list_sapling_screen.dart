...
class LeadListSaplingScreen extends StatelessWidget {
  LeadListSaplingScreen({super.key});
      ...
      () => leadsScreenController.leadList.isNotEmpty
          ...
          : Center(
              child: Column(
                ...
                children: [
                  SvgPicture.asset('assets/images/no_sapling_lead_image.svg'),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
                        'No sapling leads found',
