...
class LeadListFlowerScreen extends StatelessWidget {
  LeadListFlowerScreen({super.key});
      ...
      () => leadsScreenController.leadList.isNotEmpty
          ...
          : Center(
              child: Column(
                ...
                children: [
                  SvgPicture.asset('assets/images/no_flower_lead_image.svg'),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(
                        'No flower lead found',
